/** @file
    @brief The compiler specific configuration for gcc
    Copyright (C) 2011, 2012, 2020 emsys Embedded Systems GmbH */

#ifndef EMC_CONFIG_COMPILER_cfg_gcc_H
#define EMC_CONFIG_COMPILER_cfg_gcc_H
...
/*
 #undef HAVE_STRNLEN_FUNC
 #define HAVE_STRNLEN_FUNC 1
 */
...
// This require more detailed analysis, which version is supporting stdatomic.h
//#    if (GCC_VERSION >= 40900)
//#      undef C_LIBRARY_HAS_STDATOMIC_H
//#      define C_LIBRARY_HAS_STDATOMIC_H 1
//#    endif /* >= 4.9 */

#  endif /* >= 4 */
#endif /* >= 3 */

#endif /* EMC_CONFIG_COMPILER_cfg_gcc_H */
