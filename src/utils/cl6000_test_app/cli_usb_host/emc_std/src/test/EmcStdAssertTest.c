...
typedef int EmcStdAssertTest;

static int setUp(EmcStdAssertTest* context) { UNUSED_PARAM(context); return 1; }

static int tearDown(EmcStdAssertTest* context) { UNUSED_PARAM(context); return 1; }
...
static int test_abort(EmcStdAssertTest* context)
{
...
int main(int argc, char* argv[])
{
  ...
  EMC_SIMPLE_TEST(EmcStdAssertTest, test_abort);
  return fail_count;
}
