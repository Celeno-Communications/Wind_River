...
#ifndef EMC_SYSTEM_CELENO_DEVICE_APPLICATION_RUNTIME_FREERTOS_FreeRTOSConfig_H
#define EMC_SYSTEM_CELENO_DEVICE_APPLICATION_RUNTIME_FREERTOS_FreeRTOSConfig_H
 ...
 *---------------------------------------------------------------------------
 */
#define configNUM_THREAD_LOCAL_STORAGE_THREAD_IDX  0
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS    (configNUM_THREAD_LOCAL_STORAGE_THREAD_IDX+1)

#define XT_INTEXC_HOOKS 1
...
#if defined(__XTENSA__)
  #define configCPU_CLOCK_HZ                640000000
#else
...
#else
#define configMINIMAL_STACK_SIZE               (4096 / sizeof( StackType_t ))
#endif
/**
...
#endif /* EMC_SYSTEM_CELENO_DEVICE_APPLICATION_RUNTIME_FREERTOS_FreeRTOSConfig_H */
