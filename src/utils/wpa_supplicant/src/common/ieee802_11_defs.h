...
#define HT_OPER_OP_MODE_CHAN_CENTER_FREQ_SEG2_SHIFT     5
#define HT_OPER_OP_MODE_CHAN_CENTER_FREQ_SEG2_MASK      0x1fe0
/* BIT(5)..BIT(15), i.e., B21..B23 - Reserved */
...
#define VHT_CAP_EXT_NSS_BW_1                        ((u32) BIT(30))
#define VHT_CAP_EXT_NSS_BW_2                        ((u32) BIT(31))
#define VHT_CAP_EXT_NSS_BW_3                        ((u32) BIT(30) | BIT(31))
#define VHT_CAP_EXT_NSS_BW_MASK                     ((u32) BIT(30) | BIT(31))
#define VHT_CAP_EXT_NSS_BW_SHIFT                    30
...
#define HOSTAPD_CENTER_FREQ_NONE     0
#define HOSTAPD_CENTER_FREQ_VHT_OPER 1
#define HOSTAPD_CENTER_FREQ_HT_OPER  2
