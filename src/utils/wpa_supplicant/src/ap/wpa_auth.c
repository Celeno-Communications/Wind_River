...
#ifdef CE_DUMMY_PHY
static const u32 eapol_key_timeout_first = 30000; /* ms */
static const u32 eapol_key_timeout_subseq = 30000; /* ms */
static const u32 eapol_key_timeout_first_group = 15000; /* ms */
static const u32 eapol_key_timeout_no_retrans = 120000; /* ms */
static const int dot11RSNAConfigSATimeout = 600;
#else
...
SM_STATE(WPA_PTK, PTKCALCNEGOTIATING)
{
	...
	if (!ok) {
		...
		if (psk_found) {
			struct i802_bss *bss = ((struct hostapd_data *)(sm->wpa_auth->cb_ctx))->drv_priv;
