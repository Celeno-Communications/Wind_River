...
#define STA_PASS		false
#define STA_REJECT		true
#define STA_ST_THRESHOLD	BIT(1)
#define STA_ST_HOLDOFF		BIT(2)
#define HOLDOFF_LIST_SIZE	STA_HASH_SIZE
...
#define AP_MAX_INACTIVITY (SCALE_FACTOR * 5 * 60)
#define AP_DISASSOC_DELAY (SCALE_FACTOR * 1)
#define AP_DEAUTH_DELAY (SCALE_FACTOR * 1)
/* Number of seconds to keep STA entry with Authenticated flag after it has
 * been disassociated. */
#define AP_MAX_INACTIVITY_AFTER_DISASSOC (SCALE_FACTOR * 1 * 30)
/* Number of seconds to keep STA entry after it has been deauthenticated. */
#define AP_MAX_INACTIVITY_AFTER_DEAUTH (SCALE_FACTOR * 1 * 5)
#else
