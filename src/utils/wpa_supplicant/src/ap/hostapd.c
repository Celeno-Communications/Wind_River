...
#ifdef CONFIG_WEP		
		// Re-set key to support WEP after ifconfig down/up
				      ...
				      struct hostapd_freq_params *old_params)
{
	...
	if (old_params &&
	    hostapd_set_freq_params(old_params, conf->hw_mode,
				    ...
				    hostapd_get_actual_chwidth(conf),
	...
	case 160:
		 ...
		 */
		params->bandwidth = 80;
		params->center_freq2 = params->center_freq1;

		if (params->freq < params->center_freq1)
			params->center_freq1 -= 40;
		else
			params->center_freq1 += 40;
	...
	case 80:
		if (settings->freq_params.center_freq2 &&
		    (settings->freq_params.center_freq2 -
		      settings->freq_params.center_freq1 > 80))
			      ...
			      struct ch_switch *chs)
{
	...
	if (ch_width == CHAN_WIDTH_20_NOHT) {
		...
		settings.freq_params.he_enabled = 0;
	} else {
