...
#define MESH_ENABLED BIT(0)
	...
	int radius_addr_format_low;
	u8 radius_cm_mac[ETH_ALEN];
	int radius_fwd_id_enable;
	int radius_sta_id_enable;
...
struct hostapd_config {
	...
	u8 ht_oper_centr_freq_seg2_idx;
...
#endif /* CONFIG_IEEE80211AX */
	if (conf->ht_oper_centr_freq_seg2_idx)
		return conf->ht_oper_centr_freq_seg2_idx;
...
#endif /* CONFIG_IEEE80211AX */
	if (hostapd_get_center_freq_seg1_location(conf) == HOSTAPD_CENTER_FREQ_HT_OPER)
		conf->ht_oper_centr_freq_seg2_idx = oper_centr_freq_seg1_idx;
	else
