...
#define IEEE80211_PROBE_DELAY (ce_scale_down * HZ / 33)
#define IEEE80211_CHANNEL_TIME (ce_scale_down * HZ / 33)
#define IEEE80211_PASSIVE_CHANNEL_TIME (ce_scale_down * HZ / 9)
#else
