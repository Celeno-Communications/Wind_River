...
#ifdef CE_DUMMY_PHY
int ce_scale_down = 1;
EXPORT_SYMBOL(ce_scale_down);

#define IEEE80211_AUTH_TIMEOUT		(ce_scale_down * HZ / 5)
#define IEEE80211_AUTH_TIMEOUT_LONG	(ce_scale_down * HZ / 2)
#define IEEE80211_AUTH_TIMEOUT_SHORT	(ce_scale_down * HZ / 10)
#define IEEE80211_AUTH_TIMEOUT_SAE	(ce_scale_down * HZ * 2)
#define IEEE80211_AUTH_MAX_TRIES	3
#define IEEE80211_AUTH_WAIT_ASSOC	(ce_scale_down * HZ * 5)
#define IEEE80211_ASSOC_TIMEOUT		(ce_scale_down * HZ / 5)
#define IEEE80211_ASSOC_TIMEOUT_LONG	(ce_scale_down * HZ / 2)
#define IEEE80211_ASSOC_TIMEOUT_SHORT	(ce_scale_down * HZ / 10)
#define IEEE80211_ASSOC_MAX_TRIES	3

static int max_nullfunc_tries = 5000;
module_param(max_nullfunc_tries, int, 0644);
MODULE_PARM_DESC(max_nullfunc_tries,
		 "Maximum nullfunc tx tries before disconnecting (reason 4).");

static int max_probe_tries = 5000;
 ...
 */
static int beacon_loss_count = 0xffff;
 ...
 */
static int probe_wait_ms = 500000;
