...
/* Intel patched their 7.1.0GA linux kernel with another parameter - absolutely amazing... */
#ifdef LITEPATH_SUPPORT
	netlink_unicast(in_skb->sk, skb, NETLINK_CB(in_skb).portid, MSG_DONTWAIT, 0);
#else
