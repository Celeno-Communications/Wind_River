...
/* HCI timeouts */
#ifdef CE_DUMMY_PHY
#define HCI_DISCONN_TIMEOUT	msecs_to_jiffies(20000)  /* 20 seconds */
#define HCI_PAIRING_TIMEOUT	msecs_to_jiffies(262140) /* 262 seconds */
#define HCI_INIT_TIMEOUT	msecs_to_jiffies(50000)  /* 50 seconds */
#define HCI_CMD_TIMEOUT		msecs_to_jiffies(20000)  /* 20 seconds */
#define HCI_NCMD_TIMEOUT	msecs_to_jiffies(40000)	 /* 40 seconds */
#define HCI_ACL_TX_TIMEOUT	msecs_to_jiffies(225000) /* 225 seconds */
#define HCI_AUTO_OFF_TIMEOUT	msecs_to_jiffies(2000)   /* 2 seconds */
#define HCI_POWER_OFF_TIMEOUT	msecs_to_jiffies(5000)   /* 5 seconds */
#define HCI_LE_CONN_TIMEOUT	msecs_to_jiffies(262140) /* 262 seconds */
#define HCI_LE_AUTOCONN_TIMEOUT	msecs_to_jiffies(262140) /* 262 seconds */
#else
